...
class BasePlugin:
    ...
    def buildCommandString(self):
        ...
        if (Devices[4].nValue == 1):
            ...
            DomoticzAPI("type=command&param=setsetpoint&idx={}&setpoint=17".format(self.WACsetpoint))
        elif (Devices[3].nValue == 1):
            # general heating request....
            #for idx in self.WACsetpoint:
            DomoticzAPI("type=command&param=setsetpoint&idx={}&setpoint=28".format(self.WACsetpoint))
        else :
            # off
            #for idx in self.WACmode:
            DomoticzAPI("type=command&param=setsetpoint&idx={}&setpoint=21".format(self.WACsetpoint))
