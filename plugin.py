...
class BasePlugin:
    ...
    def buildCommandString(self):
        ...
        if (Devices[4].nValue == 1):
            requestUrl = requestUrl + "3" # general cooling request....
        elif (Devices[3].nValue == 1):
            requestUrl = requestUrl + "2" # general heating request....
        else :
            requestUrl = requestUrl + "0"  # off
        ...
        if (Devices[4].nValue == 1):
            ...
            requestUrl = requestUrl + "28" # general heating request....
        else :
            requestUrl = requestUrl + "17"  # off
